...
public class Timetable {
    ...
    public void Schedule()
    {
        try{  
            ...
            this.timetablestmt = (Statement) this.timtableCon.createStatement(); 
            try{
                String query4="update TimeSlot set isAvailable =?,courseID=?,section=?";
                PreparedStatement preparedStmt4 = this.timtableCon.prepareStatement(query4);
                preparedStmt4.setString(1,"true");
                preparedStmt4.setString(2,"null");
                preparedStmt4.setString(3,"null");
